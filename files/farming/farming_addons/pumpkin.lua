...
minetest.register_alias_force("farming_plants:melon", "farming_addons:seed_pumpkin")
minetest.register_alias_force("farming_plants:melon_fruit", "farming_addons:pumpkin_fruit")
minetest.register_alias_force("farming_plants:seed_melon", "farming_addons:seed_pumpkin")