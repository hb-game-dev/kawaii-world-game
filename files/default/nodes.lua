...
local S = translator and translator("default") or intllib.make_gettext_pair()
...
local bookshelf_formspec =
	default.gui ..
	"image[-0.23,-0.26;9,1;formspec_bookshelf_btn.png]" ..
...
minetest.register_lbm({
	...
	name = "default:bookshelf_updater_v11",
	nodenames = "default:bookshelf",
	action = function(pos)
		local meta = minetest.get_meta(pos)
		if meta:get_string("version") ~= "11" then
			update_bookshelf(pos)
			meta:set_string("version", "11")
		end
	end
})
