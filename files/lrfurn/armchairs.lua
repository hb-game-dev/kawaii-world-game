...
for i = 1, #dyes do
	local name, desc1 = unpack(dyes[i])
	...
	-- Armchair
	--
	minetest.register_alias("3d_furniture:chair_" .. name, "lrfurn:armchair_red")

	minetest.register_alias("3d_furniture:sofa_" .. name, "air")

	minetest.register_alias("3d_furniture:sofa_inv_" .. name, "air")
